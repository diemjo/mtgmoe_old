...
class MTGCard {
  ...
  @JsonKey(nullable: true, name: 'type_line')
  String typeLine;
...
class MTGCardHelper {
  static Map<String, dynamic> toMap(MTGCard card) {
    return {
      ...
      'cardFace0_colorIdentity': card.cardFaces!=null ? card.cardFaces[0].colorIdentity.join('|') : null,
      'cardFace0_manaCost': card.cardFaces!=null ? card.cardFaces[0].manaCost : null,
      'cardFace0_imageURI_png': card.cardFaces!=null ? card.cardFaces[0].imageURIs.png : null,
      'cardFace0_imageURI_borderCrop': card.cardFaces!=null ? card.cardFaces[0].imageURIs.borderCrop : null,
      'cardFace0_imageURI_artCrop': card.cardFaces!=null ? card.cardFaces[0].imageURIs.artCrop : null,
      'cardFace0_imageURI_large': card.cardFaces!=null ? card.cardFaces[0].imageURIs.large : null,
      'cardFace0_imageURI_normal': card.cardFaces!=null ? card.cardFaces[0].imageURIs.normal : null,
      'cardFace0_imageURI_small': card.cardFaces!=null ? card.cardFaces[0].imageURIs.small : null,
      ...
      'cardFace0_typeLine': card.cardFaces!=null ? card.cardFaces[0].typeLine : null,
      'cardFace1_colorIdentity': card.cardFaces!=null ? card.cardFaces[1].colorIdentity.join('|') : null,
      'cardFace1_manaCost': card.cardFaces!=null ? card.cardFaces[1].manaCost : null,
      'cardFace1_imageURI_png': card.cardFaces!=null ? card.cardFaces[1].imageURIs.png : null,
      'cardFace1_imageURI_borderCrop': card.cardFaces!=null ? card.cardFaces[1].imageURIs.borderCrop : null,
      'cardFace1_imageURI_artCrop': card.cardFaces!=null ? card.cardFaces[1].imageURIs.artCrop : null,
      'cardFace1_imageURI_large': card.cardFaces!=null ? card.cardFaces[1].imageURIs.large : null,
      'cardFace1_imageURI_normal': card.cardFaces!=null ? card.cardFaces[1].imageURIs.normal : null,
      'cardFace1_imageURI_small': card.cardFaces!=null ? card.cardFaces[1].imageURIs.small : null,
      ...
      'cardFace1_typeLine': card.cardFaces!=null ? card.cardFaces[1].typeLine : null,
    };
  }
  static MTGCard fromMap(Map<String, dynamic> map) {
    return MTGCard(
      ...
      cardFaces: (map['cardFace0_name']!=null) ? [
        MTGCardFace(
          colorIdentity: (map['cardFace0_colorIdentity'] as String).split('|'),
          ...
          typeLine: map['cardFace0_typeLine'],
        ),
        MTGCardFace(
          colorIdentity: (map['cardFace1_colorIdentity'] as String).split('|'),
          ...
          typeLine: map['cardFace1_typeLine'],
        )
      ] : [],
    );
  }
